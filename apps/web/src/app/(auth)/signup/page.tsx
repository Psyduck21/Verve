        ...
        <div className="flex flex-col space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <section className="text-left space-y-2">
                ...
                <p className="text-muted-foreground font-medium text-sm">
                    Enter your details below to create your Scheduler account.
                </p>
            </section>
            ...
            <form action={handleSubmit} className="space-y-5">
                ...
                <Button className="w-full h-12 text-base font-bold bg-primary hover:bg-primary/90 text-primary-foreground rounded-xl shadow-sm hover:shadow-md transition-all flex items-center justify-center gap-2 mt-2" type="submit" disabled={isLoading}>
