            ...
            <form action={handleSubmit} className="space-y-5">
                <div className="space-y-2">
                    ...
                    <Input
                        ...
                        name="email"
                        type="email"
                        placeholder="alex.pro@scheduler.com"
                ...
                <div className="space-y-2">
                    <div className="flex items-center justify-between ml-1">
                        ...
                        <Link href="#" className="text-xs font-bold text-primary hover:underline decoration-2 underline-offset-4">
                            Forgot Password?
                        </Link>
                    </div>
                    <Input
                ...
                <Button className="w-full h-12 text-base font-bold bg-primary hover:bg-primary/90 text-primary-foreground rounded-xl shadow-sm hover:shadow-md transition-all flex items-center justify-center gap-2" type="submit" disabled={isLoading}>
